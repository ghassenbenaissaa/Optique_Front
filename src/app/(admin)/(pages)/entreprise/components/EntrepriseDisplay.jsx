      ...
      <div className="card">
        <div className="p-6">
          <div className="flex justify-center items-center py-8">
            ...
            <span className="text-gray-600">Chargement des informations...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="card">
        <div className="p-6">
          <div className="text-center py-12">
            <i className="mgc_building_2_line text-6xl text-gray-300 mb-6"></i>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-900 font-semibold text-lg">{entreprise.nom}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-900 font-mono">{entreprise.numeroFiscal}</p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-900">{entreprise.adresse}</p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-blue-900 text-xl font-bold">{entreprise.tva}%</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <label className="block text-sm font-medium text-green-700 mb-1">
                Timbre fiscal
              </label>
              <p className="text-green-900 text-xl font-bold">{entreprise.timbreFiscale} DT</p>
            </div>
          </div>
        </div>
      </div>
