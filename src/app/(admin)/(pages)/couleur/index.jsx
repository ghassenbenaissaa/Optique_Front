...
const Index = () => {
  ...
  const [couleurToEdit, setCouleurToEdit] = useState(null);
  ...
  const handleShowModification = (couleur) => {
    setCouleurToEdit(couleur);
  ...
  return <>
    <PageMeta title="Couleur" />
    <main>
      <PageBreadcrumb title="Couleur" />
      {showFormulaire ? (
        ...
        <Tableau
          onAddCouleur={handleShowFormulaire}
          onEditCouleur={handleShowModification}
        />
      )}
    </main>
  </>;
